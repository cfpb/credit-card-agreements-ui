...
export class Company extends React.Component {
  ...
  render() {
    ...
    return (
      <CollapsibleFilter title="Credit card name"
                         desc={desc}
  ...
  _onInputChange( value ) {
    ...
    const uri = '@@API/credit/autocomplete/' + qs
  ...
  _onOptionSelected( item ) {
    this.props.typeaheadSelect( { value: item.planId, label: item.label } )
  }
}
